...
songplay_table_create = "CREATE TABLE IF NOT EXISTS songplays (songplay_id text, start_time int, user_id text, level text, song_id text, artist_id int, session_id int, location text, user_agent text)"
